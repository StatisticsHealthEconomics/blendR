...
## ----observedplot, echo=FALSE, fig.cap="Survival estimates of the FCR arm based on the piecewise exponential model fitted to the observed data"----
...
## ----blendedplot, echo=FALSE, fig.cap="Blended survival curve based on short-term data and external information for FCR arm"----
ggplot() + geom_line(aes(obs_Surv$KM$time, obs_Surv$KM$surv, colour = "Kaplan-Meier"), size = 1.25, linetype = "dashed")+
  xlim(0, 180) + ylim(0,1) +
