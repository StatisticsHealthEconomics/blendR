...
This is a format taken from Jackson and his package [ref].
The idea is that at discrete time risk set sizes and then number of events are defined these can be over lapping with other risk sets and event counts.
